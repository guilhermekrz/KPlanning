...
public class HeuristicReachableStatesStrategyTest {
	...
	public void getReachableStates1() throws Exception {
		...
		Set<STRIPSState> allReachableStates = adapter.getJavaffParser().getAllReachableStates(new HeuristicReachableStatesStrategy());
